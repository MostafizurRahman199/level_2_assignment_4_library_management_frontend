...
//       <div className="max-w-lg w-full bg-white/70 backdrop-blur-md shadow-2xl rounded-3xl p-8 border border-white/20 relative overflow-hidden">
...
//         <div className="absolute -bottom-16 -left-16 w-32 h-32 bg-gradient-to-tr from-cyan-400/20 to-blue-500/20 rounded-full blur-2xl"></div>
